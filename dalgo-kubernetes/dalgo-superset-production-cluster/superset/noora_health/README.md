...
<!-- helm upgrade --install --values values5.0.0.yaml  noora superset/superset --version 0.14.1 --namespace superset --debug -->
helm upgrade --install --values values6.0.0.yaml  noora superset/superset --version 0.14.1 --namespace superset --debug
